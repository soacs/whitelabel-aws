...
while read -r name; do
 ...
 sed -i.bak -e 's/collaborationcapital.eapaws.foliofn.com/uat.invest.collaboration.capital/g' ../../../../dynamodb-records/$BRAND/$name.json
done
...
while read -r name; do
 ...
 sed -i.bak -e 's/uat.invest.collaboration.capital/invest.collaboration.capital/g' ../../../../dynamodb-records/$BRAND/$name.json
done
