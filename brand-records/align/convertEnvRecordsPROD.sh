...
while read -r name; do
 ...
 if [ $TARGET='prod' ]
  then
    ...
    sed -i.bak -e 's/'$SOURCE'.invest.earthequityalign.com/invest.earthequityalign.com/g' ../../../../dynamodb-records/$BRAND/$TARGET/$name.json
    ...
    sed -i.bak -e 's/UA-157148597-2/G-X05KW7FXSB/g' ../../../../dynamodb-records/$BRAND/$TARGET/$name.json
    sed -i.bak -e 's/UA-157739352-2/UA-157739352-2/g' ../../../../dynamodb-records/$BRAND/$TARGET/$name.json
  fi
done
