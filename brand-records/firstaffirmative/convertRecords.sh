...
while read -r name; do
 ...
 sed -i.bak -e 's/firstaffirmative.eapaws.foliofn.com/uat.dwsp.firstaffirmative.com/g' ../../../../dynamodb-records/$BRAND/$name.json
done
...
while read -r name; do
 ...
 sed -i.bak -e 's/uat.dwsp.firstaffirmative.com/dwsp.firstaffirmative.com/g' ../../../../dynamodb-records/$BRAND/$name.json
done
...
cp ../../../../dynamodb-records/$BRAND/*.json ../../../../dynamodb-records/$BRAND/prod
 ...
 if [ $TARGET='uat' ]
 then
   sed -i.bak -e 's/'$BRAND'.'$SOURCE'aws.foliofn.com/'$TARGET'.dwsp.firstaffirmative.com/g' ../../../../dynamodb-records/$BRAND/$TARGET/$name.json
 fi
