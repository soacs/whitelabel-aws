...
while read -r name; do
 ...
 if [ $TARGET='prod' ]
  then
    ...
    sed -i.bak -e 's/UA-157168220-3/G-E5Z1CWNC7W/g' ../../../../dynamodb-records/$BRAND/$TARGET/$name.json
    sed -i.bak -e 's/UA-157168220-3/UA-157168220-3/g' ../../../../dynamodb-records/$BRAND/$TARGET/$name.json
  fi
done
